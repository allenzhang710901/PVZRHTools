    ...
    */
                ...
                if (__instance != null)
                {
                    switch (__instance.thePlantType)
                    {
                        ...
                        case PlantType.SuperStar:
                            DisplayedString += '\n' + impactCooldownText + board.bigStarPassiveCountDown.ToString("0.0") + "s";
                            break;
                        case PlantType.UltimateStar:
                            DisplayedString += '\n' + ultimateCooldownText + board.ultimateStarCountDown.ToString("0.0") + "s";
                            break;
    ...
    public class Zombie_HealthTextPatch
    {
        ...
        public static void Postfix(Zombie __instance)
        {
            ...
            {
                int count = 0;
                foreach (Plant p in board.plantArray)
                {
                    if (p != null)
                    {
