...
public class Core : MelonMod
{
    ...
    public static Lazy<MelonPreferences_Entry<string>> ModsHash { get; set; } = new();
    ...
    public override void OnInitializeMelon()
    {
        ...
        Config = new Lazy<MelonPreferences_Category>(MelonPreferences.CreateCategory("PVZRHTools"));
        Port = new Lazy<MelonPreferences_Entry<int>>(Config.Value.CreateEntry("Port", 13531));
        AlmanacZombieMindCtrl =
            new Lazy<MelonPreferences_Entry<bool>>(Config.Value.CreateEntry(nameof(AlmanacZombieMindCtrl), false));
        KeyTimeStop =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyTimeStop), KeyCode.Alpha5));
        KeyShowGameInfo =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyShowGameInfo),
                KeyCode.BackQuote));
        KeyAlmanacCreatePlant =
            new Lazy<MelonPreferences_Entry<KeyCode>>(
                Config.Value.CreateEntry(nameof(KeyAlmanacCreatePlant), KeyCode.B));
        KeyAlmanacCreateZombie =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyAlmanacCreateZombie),
                KeyCode.N));
        KeyAlmanacZombieMindCtrl =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyAlmanacZombieMindCtrl),
                KeyCode.LeftControl));
        KeyTopMostCardBank =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyTopMostCardBank),
                KeyCode.Tab));
        KeyAlmanacCreatePlantVase =
            new Lazy<MelonPreferences_Entry<KeyCode>>(Config.Value.CreateEntry(nameof(KeyAlmanacCreatePlantVase),
                KeyCode.J));
    ...
    public static bool LoadPlantData()
    {
        try
        {
            ...
            for (var i = 1; i < lines.Length; i++) // 跳过标题行
            {
                ...
                if (fields.Length < 7)
                {
                    MLogger.Error($"Invalid plant data format at line {i + 1}");
                    continue;
                }
        ...
        {
            MLogger.Error(e1);
            MLogger.Error("plant_data.csv被占用");
        }
